...
//                     Verbe(level: Level.B2, form: Form.toChange, verbe: ("bebringen", "er ", "er ", "er hat "), translations: [(Lang.fr, ""), (Lang.en, "")]),
            ...
            Verbe(level: Level.B2, form: Form.undefine, verbe: ("ankommen", "er kommt … an", "er kam … an", "er ist … angekommen"), translations: [(Lang.fr, "arriver"), (Lang.en, "to arrive")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("anziehen", "er zieht … an", "er zog … an", "er hat angezogen"), translations: [(Lang.fr, "mettre (un habit)"), (Lang.en, "to put/dress")]),
            ...
            Verbe(level: Level.B1, form: Form.iao, verbe: ("beginnen", "er beginnt", "er begann", "er hat begonnen"), translations: [(Lang.fr, "commencer"), (Lang.en, "to begin")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("bieten", "er bietet", "er bot", "er hat geboten"), translations: [(Lang.fr, "offrir, proposer"), (Lang.en, "to offer")]),
            ...
            Verbe(level: Level.B1, form: Form.eiieie, verbe: ("bleiben", "er bleibt", "er blieb", "er ist geblieben"), translations: [(Lang.fr, "rester"), (Lang.en, "to stay")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("bringen", "er bringt", "er brachte", "er hat gebracht"), translations: [(Lang.fr, "apporter"), (Lang.en, "to bring")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("denken", "er denkt", "er dachte", "er hat gedacht"), translations: [(Lang.fr, "penser"), (Lang.en, "to think")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("dürfen", "er darf", "er durfte", "er hat durft"), translations: [(Lang.fr, "pouvoir"), (Lang.en, "to may, to be allowed")]),
            ...
            Verbe(level: Level.B1, form: Form.aua, verbe: ("einladen", "er lädt … ein", "er lud … ein", "er hat eingeladen"), translations: [(Lang.fr, "inviter"), (Lang.en, "to invite so.")]),
            ...
            Verbe(level: Level.B1, form: Form.eae, verbe: ("essen", "er isst", "er aß", "er hat gegessen"), translations: [(Lang.fr, "manger"), (Lang.en, "to eat")]),
            ...
            Verbe(level: Level.B1, form: Form.aua, verbe: ("fahren", "er fährt", "er fuhr", "er ist gefahren"), translations: [(Lang.fr, "aller (en véhicule)"), (Lang.en, "to drive, go")]),
            Verbe(level: Level.B1, form: Form.aiea, verbe: ("fallen", "er fällt", "er fiel", "er ist gefallen"), translations: [(Lang.fr, "tomber"), (Lang.en, "to fall")]),
            ...
            Verbe(level: Level.B1, form: Form.iau, verbe: ("finden", "er findet", "er fand", "er hat gefunden"), translations: [(Lang.fr, "trouver"), (Lang.en, "to find")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("fliegen", "er fliegt", "er flog", "er ist geflogen"), translations: [(Lang.fr, "voler"), (Lang.en, "to fly")]),
            ...
            Verbe(level: Level.B1, form: Form.eae, verbe: ("geben", "er gibt", "er gab", "er hat gegeben"), translations: [(Lang.fr, "donner"), (Lang.en, "to give")]),
            ...
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("gehen", "er geht", "er ging", "er ist gegangen"), translations: [(Lang.fr, "aller, marcher"), (Lang.en, "to walk, go")]),
            ...
            Verbe(level: Level.B1, form: Form.iao, verbe: ("gewinnen", "er gewinnt", "er gewann", "er hat gewonnen"), translations: [(Lang.fr, "gagner"), (Lang.en, "to win, gain")]),
            ...
            Verbe(level: Level.B2, form: Form.eiii, verbe: ("gleichen", "er gleicht", "er glich", "er hat geglichen"), translations: [(Lang.fr, "ressembler"), (Lang.en, "to resemble")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("haben", "er hat", "er hatte", "er hat gehabt"), translations: [(Lang.fr, "avoir"), (Lang.en, "to have")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("heißen", "er heißt", "er hieß", "er hat geheißen"), translations: [(Lang.fr, "s’appeler"), (Lang.en, "to be called")]),
            Verbe(level: Level.B1, form: Form.eao, verbe: ("helfen", "er hilft", "er half", "er hat geholfen"), translations: [(Lang.fr, "aider"), (Lang.en, "to help")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("kennen", "er kennt", "er kannte", "er hat gekannt"), translations: [(Lang.fr, "connaître"), (Lang.en, "to know")]),
            ...
            Verbe(level: Level.B1, form: Form.iau, verbe: ("klingen", "er klingt", "er klang", "er hat geklungen"), translations: [(Lang.fr, "sonner"), (Lang.en, "to sound")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("können", "er kann", "er konnte", "er hat gekonnt"), translations: [(Lang.fr, "pouvoir"), (Lang.en, "to can")]),
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("kommen", "er kommt", "er kam", "er ist gekommen"), translations: [(Lang.fr, "venir"), (Lang.en, "to come")]),
            ...
            Verbe(level: Level.B1, form: Form.aiea, verbe: ("lassen", "er lässt", "er ließ", "er hat gelassen"), translations: [(Lang.fr, "laisser"), (Lang.en, "to let")]),
            ...
            Verbe(level: Level.B1, form: Form.eae, verbe: ("lesen", "er liest", "er las", "er hat gelesen"), translations: [(Lang.fr, "lire"), (Lang.en, "to read")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("mögen", "er mag", "er mochte", "er hat gemocht"), translations: [(Lang.fr, "aimer"), (Lang.en, "to like")]),
            Verbe(level: Level.B1, form: Form.weak, verbe: ("müssen", "er muss", "er musste", "er hat gemusst"), translations: [(Lang.fr, "devoir"), (Lang.en, "to have to")]),
            ...
            Verbe(level: Level.B1, form: Form.eao, verbe: ("nehmen", "er nimmt", "er nahm", "er hat genommen"), translations: [(Lang.fr, "prendre"), (Lang.en, "to take")]),
            ...
            Verbe(level: Level.B2, form: Form.aiea, verbe: ("raten", "er rät", "er riet", "er hat geraten"), translations: [(Lang.fr, "deviner"), (Lang.en, "to advise")]),
            ...
            Verbe(level: Level.B1, form: Form.eiii, verbe: ("reiten", "er reitet", "er ritt", "er ist geritten"), translations: [(Lang.fr, "faire du cheval"), (Lang.en, "to ride (a horse)")]),
            ...
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("rufen", "er ruft", "er rief", "er hat gerufen"), translations: [(Lang.fr, "appeler"), (Lang.en, "to call, cry out")]),
            ...
            Verbe(level: Level.B1, form: Form.aiea, verbe: ("schlafen", "er schläft", "er schlief", "er hat geschlafen"), translations: [(Lang.fr, "dormir"), (Lang.en, "to sleep")]),
            Verbe(level: Level.B1, form: Form.aua, verbe: ("schlagen", "er schlägt", "er schlug", "er hat geschlagen"), translations: [(Lang.fr, "frapper"), (Lang.en, "to hit, beat")]),
            ...
            Verbe(level: Level.B1, form: Form.eiieie, verbe: ("schreiben", "er schreibt", "er schrieb", "er hat geschrieben"), translations: [(Lang.fr, "écrire"), (Lang.en, "to write")]),
            ...
            Verbe(level: Level.B1, form: Form.iao, verbe: ("schwimmen", "er schwimmt", "er schwamm", "er ist geschwommen"), translations: [(Lang.fr, "nager"), (Lang.en, "to swim")]),
            ...
            Verbe(level: Level.B1, form: Form.eae, verbe: ("sehen", "er sieht", "er sah", "er hat gesehen"), translations: [(Lang.fr, "voir"), (Lang.en, "to see")]),
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("sein", "er ist", "er war", "er ist gewesen"), translations: [(Lang.fr, "être"), (Lang.en, "to be")]),
            ...
            Verbe(level: Level.B1, form: Form.iau, verbe: ("singen", "er singt", "er sang", "er hat gesungen"), translations: [(Lang.fr, "chanter"), (Lang.en, "to sing")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("sollen", "er soll", "er sollte", "er hat gesollt"), translations: [(Lang.fr, "devoir"), (Lang.en, "shall")]),
            ...
            Verbe(level: Level.B1, form: Form.eao, verbe: ("sprechen", "er spricht", "er sprach", "er hat gesprochen"), translations: [(Lang.fr, "parler"), (Lang.en, "to speak")]),
            ...
            Verbe(level: Level.B1, form: Form.eiieie, verbe: ("steigen", "er steigt", "er stieg", "er ist gestiegen"), translations: [(Lang.fr, "monter"), (Lang.en, "to climb")]),
            ...
            Verbe(level: Level.B2, form: Form.iau, verbe: ("stinken", "er stinkt", "er stank", "er hat gestunken"), translations: [(Lang.fr, "puer"), (Lang.en, "to stink")]),
            ...
            Verbe(level: Level.B1, form: Form.aua, verbe: ("tragen", "er trägt", "er trug", "er hat getragen"), translations: [(Lang.fr, "porter"), (Lang.en, "to wear, carry")]),
            Verbe(level: Level.B1, form: Form.eao, verbe: ("treffen", "er trifft", "er traf", "er hat getroffen"), translations: [(Lang.fr, "rencontrer"), (Lang.en, "to meet")]),
            ...
            Verbe(level: Level.B1, form: Form.iau, verbe: ("trinken", "er trinkt", "er trank", "er hat getrunken"), translations: [(Lang.fr, "boire"), (Lang.en, "to drink")]),
            ...
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("tun", "er tut", "er tat", "er hat getan"), translations: [(Lang.fr, "faire"), (Lang.en, "to do")]),
            ...
            Verbe(level: Level.B1, form: Form.eae, verbe: ("vergessen", "er vergisst", "er vergaß", "er hat vergessen"), translations: [(Lang.fr, "oublier"), (Lang.en, "to forget")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("verlieren", "er verliert", "er verlor", "er hat verloren"), translations: [(Lang.fr, "perdre"), (Lang.en, "to lose")]),
            ...
            Verbe(level: Level.B1, form: Form.undefine, verbe: ("verstehen", "er versteht", "er verstand", "er hat verstanden"), translations: [(Lang.fr, "comprendre"), (Lang.en, "to understand")]),
            ...
            Verbe(level: Level.B1, form: Form.aua, verbe: ("waschen", "er wäscht", "er wusch", "er hat gewaschen"), translations: [(Lang.fr, "laver"), (Lang.en, "to wash")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("werden", "er wird", "er wurde", "er ist geworden"), translations: [(Lang.fr, "devenir"), (Lang.en, "to become")]),
            Verbe(level: Level.B1, form: Form.eao, verbe: ("werfen", "er wirft", "er warf", "er hat geworfen"), translations: [(Lang.fr, "lancer, jeter"), (Lang.en, "to throw")]),
            ...
            Verbe(level: Level.B1, form: Form.weak, verbe: ("wissen", "er weiß", "er wusste", "er hat gewusst"), translations: [(Lang.fr, "savoir"), (Lang.en, "to know")]),
            Verbe(level: Level.B1, form: Form.weak, verbe: ("wollen", "er will", "er wollte", "er hat gewollt"), translations: [(Lang.fr, "vouloir"), (Lang.en, "to will")]),
            ...
            Verbe(level: Level.B1, form: Form.ieoo, verbe: ("ziehen", "er zieht", "er zog", "er hat gezogen"), translations: [(Lang.fr, "tirer"), (Lang.en, "to pull, move")]),
